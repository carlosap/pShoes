...
namespace Tests.IntegrationTests.Cart.CartUpdateTests
{
    [TestClass]
    public class When_getting_updating_item_quantity
    {
        public static Response<CartResponse> _result;
        public static CartUpdate _testObject;
        ...
        public void It_should_return_valid_DWQuery()
        {
            ...
            _itemCountAfter.Should().BeGreaterThan(_itemCountBefore);
        }
    }
}
