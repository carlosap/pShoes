...
{
    [TestClass]
    public class When_requesting_list_of_shipping_methods
    {
        public static Response<GetShippingMethodsResponse> _result;
        public static GetShippingMethods _testObject;
