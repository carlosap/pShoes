...
{
    [TestClass]
    public class When_getting_account_addresses
    {
        public static Response<GetAccountAddressesResponse> _result;
        public static GetAccountAddresses _testObject;
        ...
        {
            _result.resultset.Addresses.Should().NotBeEmpty();
        }
    }
}
